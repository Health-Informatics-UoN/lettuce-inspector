...
tests = [
        InformationRetrievalPipelineTest("pubmedbert retrieval (short strings)", pubmedbert_retriever, retrieval_metrics),
        *[
            RAGPipelineTest(
                f"{name} RAG with pubmedbert (short strings)",
                pipeline,
                generation_metrics,
                )
...
framework = EvaluationFramework(
        name = "Pubmedbert test (short strings)",

...
from evaluation.pipelines import DuckdbRAGChatPipeline
...
## Pipelines
Generation: pubmedbert for RAG, concept names only in prompt
    - llama 3.2 3B
    - llama 3.1 8B
    - phi-4
    - Qwen2.5 14b
...
framework = EvaluationFramework(
        name = "Pubmedbert test (short strings, concept names only in prompt)",

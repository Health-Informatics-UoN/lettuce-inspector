...
tests = [
        InformationRetrievalPipelineTest("BGE-small (short strings)", pubmedbert_retriever, retrieval_metrics),
        *[
            RAGPipelineTest(
                f"{name} RAG with BGE-small (short strings)",
                pipeline,
                generation_metrics,
                )
...
framework = EvaluationFramework(
        name = "BGE-small test (short strings)",

...
## Pipelines
Generation: BGE-small for RAG using concept attributes in the prompt
    - llama 3.2 3B
    - llama 3.1 8B
    - phi-4
    - Qwen2.5 14b
...
tests = [
        *[
            RAGPipelineTest(
                f"{name} RAG with BGE-small (long strings, concept attributes in prompt)",
                pipeline,
                generation_metrics,
                )
...
framework = EvaluationFramework(
        name = "BGE-small test (long strings, concept attributes in prompt)",

...
LLMs:
- llama-3.2 3b, quantized to 6 bit precision
- Med-llama 3 8b v4, quantized to 3 bit precision
- Gemma 7b, quantized to 4 bit precision
Vector Search:
...
llama_rag_prompt_template = template_env.from_string(
...
# med_llama_pipeline = RAGChatPipeline(
#         llm=llms["med_llama"],
#         system_prompt=rag_system_prompt,
#         prompt_template=llama_rag_prompt_template,
#         template_vars=template_vars,
...
tests = [
    ...
    # RAGPipelineTest("Med Llama", med_llama_pipeline, metrics),
